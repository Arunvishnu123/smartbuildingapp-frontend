...
<div class="heater-data-contents">
    ...
    <w-flex>
        <w-button @click="editheater()" class="edit-heater ma1" color="white" bg-color="indigo-dark5" icon="fa fa-pencil"></w-button>
        <w-button @click="deleteheaterConfirm()" class="edit-heater ma1" color="white" bg-color="red" icon="fa fa-trash-o"></w-button>
    ...
    <div class="heater-temp-desgin">
        <w-tag class="heater-status" v-model="tagOn" :bg-color="tagOn ? 'success-dark2' : 'error-dark2'" dark lg>
            {{ tagOn ? "Turn ON Heater" : "Turn OFF Heater" }}
        </w-tag>
    </div>
</div>
</template>
